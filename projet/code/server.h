...
public:
	...
	void consoleWrite(string dataSens_p);//visualiser les donn¨¦e

	void fileWrite(string dataSens_p,int i);//stocker les donn¨¦es des capteurs(chaque capteur disposer de son ficher
